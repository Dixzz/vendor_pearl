...
ALARM_PATH := vendor/pearl/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/pearl/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/pearl/prebuilt/common/media/audio/ringtones
