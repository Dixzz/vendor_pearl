...
PEARL_VERSION := Pearl-$(PEARL_BASE_VERSION)-$(DATE)-$(PEARL_BUILD)-$(PEARL_BUILD_TYPE)
else
...
ROM_FINGERPRINT := Pearl/$(PEARL_BASE_VERSION)/$(PLATFORM_VERSION)/$(TARGET_PRODUCT_SHORT)/$(PEARL_BUILD_DATE)
